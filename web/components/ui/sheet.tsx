  ...
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        side === "right" && "inset-y-0 right-0 h-full w-full max-w-2xl border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right",
        side === "left" && "inset-y-0 left-0 h-full w-full max-w-2xl border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left",
